...
package Messages{
    ...
    sub sendSms {
        my $self = shift;
        my ($phone, $text,$sender,%params) = @_;
        $params{'phone'}  = $phone;
        $params{'text'}   = $text;
        $params{'sender'} = $sender;
        return $self->{parent}->call('messages/send_sms',%params);
    };
    ''//'
        ...
        *          option string "text"
    ';
    sub sendPersonalized() {

        my $self = shift;
        my $mes = '';
        foreach my $name (sort keys @{$_[0]}) {
            $mes = $mes.$_[0][$name][1].":".$_[0][$name][3]."]|[";
        }
        my %params ;
        foreach my $name (sort keys %{$_[2]}) {
           $params{$name} = $_[2]{$name};
        }
        $params{sender} = $_[1];
        $params{messages} =  $mes;
        return $self->{parent}->call('messages/send_personalized',%params);
    };
    ''//'
    ...
    sub sendVoice {
        ...
        my ($phone,%params) = @_;
        $params{'phone'}  = $phone;
        return $self->{parent}->call('messages/send_voice',%params);
    };
    ''//'
        * Sending MMS
        * 
    ...
    sub sendMms {
        my $self = shift;
        my ($phone,$title,%params) = @_;
        $params{'phone'}  = $phone;
        $params{'title'}  = $title;

        return $self->{parent}->call('messages/send_mms',%params);
    };
    ''//'
        * View single message
        * 
    ...
    sub view {
        ...
        my ($id,%params) = @_;
        $params{'id'}  = $id;
        return $self->{parent}->call('messages/view',%params);
    };
    ''//'
    ...
    sub reports {
        my $self = shift;
        my (%params) = @_;
        return $self->{parent}->call('messages/reports',%params);
    };
    ''//'
    ...
    sub delete {
        ...
        return $self->{parent}->call('messages/delete',%params);
    };
    ''//'
    ...
    sub recived {
        ...
        my ($type,%params ) = @_;
        $params{'type'}  = $type;
        return $self->{parent}->call('messages/recived',%params);
    };
    ''//'
    ...
    sub  sendNd {
        ...
        return $self->{parent}->call('messages/send_nd',%params);
    };
    ''//'
    ...
    sub  sendNdi {
        my $self = shift;
        my ($phone,$text,$ndi_number ) = @_;
        my %params = (
            'phone' => $phone,
            'text'  => $text,
            'ndi_number' => $ndi_number
        );
        return $self->{parent}->call('messages/send_ndi',%params);
    };
    return 1; 
}